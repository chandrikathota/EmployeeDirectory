...
.then(data=>{
    ...
    document.getElementById("clear-btn").addEventListener("click",clearSearchBar)
    function openPopup(){
    ...
    document.getElementById("viewmore-btn").addEventListener("click",handleViewMoreButton)
    ...
    document.getElementById("submit-btn").addEventListener("click",addNewEmployeeDetails)
